...
import { faBars, faTimes, faMobileScreen } from '@fortawesome/free-solid-svg-icons';
            ...
            <nav className="flex justify-between items-center w-[92%] md:-mt-12 xl:-mt-20 -mt-5">
                ...
                <div className="hidden md:flex cursor-pointer">
                    <ul className="flex gap-16">
                        ...
                        <li onClick={goToAgriISmart} className="hover:text-purple-300 text-purple-400 text-base hover:underline hover:underline-offset-4 decoration-white decoration-solid flex items-center">
            ...
            {menuOpen && (
                <div className="fixed inset-0 bg-white z-50 flex flex-col items-center justify-center">
                    ...
                    <ul className="flex flex-col gap-6 text-center -mt-14">
                        ...
                        <li onClick={handleDonateClick} className="hover:text-purple-300 text-purple-400 text-base hover:underline hover:underline-offset-4 decoration-white decoration-solid">Invest Us</li>
                        <li onClick={goToAgriISmart} className="hover:text-purple-300 text-purple-400 text-base hover:underline hover:underline-offset-4 decoration-white decoration-solid flex items-center justify-center">
                            <FontAwesomeIcon icon={faMobileScreen} className="mr-2" />
                            AgriISmart
                        </li>
                    </ul>
